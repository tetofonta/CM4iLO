...
void StartDefaultTask(void *argument) __noreturn;
...
static void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOE, CODE_DAT_Pin | CODE_CLK_Pin | PE_RUN_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_6, GPIO_PIN_RESET);

    /*Configure GPIO pins : CODE_DAT_Pin CODE_CLK_Pin */
    GPIO_InitStruct.Pin = CODE_DAT_Pin | CODE_CLK_Pin;
    ...
    /*Configure GPIO pin : PE_RUN_Pin */
    GPIO_InitStruct.Pin = PE_RUN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(PE_RUN_GPIO_Port, &GPIO_InitStruct);
